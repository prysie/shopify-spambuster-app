...
const rootReducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case APPSTATUS_GET_DONE:
      ...
      state = state.set('enablementLink', 'https://' + shop + '/admin/themes/current/editor?context=apps' + '&template=' + '$' +'&activateAppId=' + '7f2f526f-ddcb-445c-9bc7-75d61af80dcb' + '/' + 'reCAPTCHA-spambuster')
